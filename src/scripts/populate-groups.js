 ...
 * Here is populating
 */
var populateGroups = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, database_connection_1.sequelize.authenticate()];
            case 1:
                _a.sent();
                return [4 /*yield*/, group_model_definition_1.Group.sync({ force: true })];
            case 2:
                _a.sent();
                return [4 /*yield*/, group_model_definition_1.Group.bulkCreate(defaultData)];
            case 3:
                _a.sent();
                return [2 /*return*/];
        }
