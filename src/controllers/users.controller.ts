 ...
 */
routerUsers.get('/', validator.query(getUsersQuerySchema), async (req: Request, res: Response) => {
 ...
 */
routerUsers.get('/:userId', async (req: Request, res: Response) => {
 ...
 * optional
 */
routerUsers.put('/:userId',  async (req: Request, res: Response) => {
 ...
 */
routerUsers.delete('/:userId', async (req: Request, res: Response) => {
    const user: UserInstance | null = await userService.getUserById(req.params.userId);
